describe('i18n check', () => {
  it('Renders frontpage in danish initially and toggles to english', () => {
    ...
    cy.get('p#me').should('have.text', 'Jeg hedder Nicolai Bo Kunkel, er 26 år gammel, uddannet datamatiker og fornyeligt færdiguddannet med min overbygningsprofessionsbachelor i softwareudvikling på Erhvervsakademi København.');
    ...
    cy.get('p#me').should('have.text', 'My name is Nicolai Bo Kunkel, I am 26 years old, a graduate of Computer Science, and recently completed my top-up Bachelor\'s degree in Software Development at Copenhagen School of Design and Technology.');
